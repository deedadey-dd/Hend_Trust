...
import { Shield, LayoutDashboard, Link2, LogIn, UserPlus, LogOut, Menu, X, Wallet, MapPin, UserCircle } from 'lucide-react';
          ...
          <nav className="hidden md:flex items-center gap-1">
            {isAuthenticated ? (
              <>
                ...
                {navLink('/track', 'Track Order', <MapPin className="h-4 w-4" />)}
